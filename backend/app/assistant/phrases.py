...
def system_prompt(language: Language) -> str:
    ...
    return (
        ...
        "6. Не больше четырёх предложений и не больше 60 слов. Это жёсткий "
        "предел, а не пожелание: длинный ответ обрывается на полуслове "
        "и не доходит до клиента.\n"
        "7. Без приветствия, без подписи, без повторения вопроса.\n"
        "8. Последним предложением скажи, что делать дальше.\n"
        "9. Не переводи и не дублируй ответ на другие языки.\n\n"
