 ...
 * панель существует и что значат её числа. Их 55 блоков примерно
 * на полторы тысячи слов, и написаны они как объяснение читателю,
 * а не как текст продукта. Они остаются русскими, а в казахском
 * и английском режимах убираются под переключатель: неполный перевод
 * технической прозы читался бы хуже, чем честное её отсутствие.
 *
...
export const DICTIONARY = {
  ...
  'curve.qualityTitle': entry(
    'Точность и полнота',
    'Дәлдік пен толықтық',
    'Precision and recall',
  ),
  'curve.atThreshold': entry('при пороге {score}', '{score} шегінде', 'at threshold {score}'),
