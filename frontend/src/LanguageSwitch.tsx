 ...
 * Сказать прямо лучше, чем показать двадцать тысяч слов машинного
 ...
 * одно правило вместо двухсот тридцати правок по компонентам, —
 * а этот переключатель их возвращает.
 */
