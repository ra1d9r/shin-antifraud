...
| 4 | Крупная сумма | повышенный риск | **55** | `CHALLENGE` | `MEDIUM` |
...
|---|---|---|---|
| `travel_speed_kmh` | 1 | -0.6971 | понижает |
| `hours_since_previous` | 5.00 | +0.4251 | повышает |
| `amount_zscore` | 0.0 | -0.4005 | понижает |
| `transaction_frequency` | 3 | +0.3769 | повышает |
| `amount_deviation_ratio` | 1.0 | -0.3760 | понижает |
...
| Признак | Значение | Вклад | Направление |
|---|---|---|---|
| `is_new_device` | yes | +5.4369 | повышает |
| `is_vpn_ip` | yes | +1.9550 | повышает |
| `transaction_frequency` | 3 | +0.6871 | повышает |
| `travel_speed_kmh` | 1 | -0.4685 | понижает |
| `hours_since_previous` | 5.00 | +0.4004 | повышает |
...
|---|---|
| Risk Score | **55** |
| Оценка модели без правил | 4 |
| Вероятность фрода | 0.0368 |
| Decision | **`CHALLENGE`** |
| Risk Level | `MEDIUM` |
| Поднято политиками | да |
...
| Признак | Значение | Вклад | Направление |
|---|---|---|---|
| `is_high_risk_country` | yes | +1.8014 | повышает |
| `travel_speed_kmh` | 396 | +1.7843 | повышает |
| `geo_distance_km` | 7921 | +1.2681 | повышает |
| `is_unusual_country` | yes | +0.8193 | повышает |
| `country_changed_from_previous` | yes | +0.5279 | повышает |
...
|---|---|
| Risk Score | **55** |
| Оценка модели без правил | 55 |
| Вероятность фрода | 0.5465 |
| Decision | **`CHALLENGE`** |
| Risk Level | `MEDIUM` |
| Поднято политиками | нет |
...
| Признак | Значение | Вклад | Направление |
|---|---|---|---|
| `amount_zscore` | 50.0 | +5.2735 | повышает |
| `amount_deviation_ratio` | 25.0 | +2.8023 | повышает |
| `amount_log` | 7.82 | +0.7018 | повышает |
| `is_weekend` | no | +0.5697 | повышает |
| `frequency_ratio` | 1.0 | +0.4905 | повышает |
...
| Признак | Значение | Вклад | Направление |
|---|---|---|---|
| `amount_zscore` | 50.0 | +2.9372 | повышает |
| `travel_speed_kmh` | 21602 | +2.9254 | повышает |
| `is_impossible_travel` | yes | +2.3775 | повышает |
| `is_new_device` | yes | +1.8803 | повышает |
| `is_vpn_ip` | yes | +1.7825 | повышает |
...
| Признак | Значение | Вклад | Направление |
|---|---|---|---|
| `txn_count_last_hour` | 9 | +3.7138 | повышает |
| `frequency_ratio` | 7.3 | +2.7174 | повышает |
| `hours_since_previous` | 0.10 | -0.5205 | понижает |
| `amount_zscore` | 0.0 | -0.4585 | понижает |
| `is_weekend` | no | +0.4367 | повышает |
