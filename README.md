...
**Список стран повышенного риска от провайдера.** Сейчас он зашит
константой. В проде такие списки приходят от провайдера риск-данных
и обновляются без выкатки.
