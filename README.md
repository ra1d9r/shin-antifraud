...
**Подробные пояснения к панелям остались русскими.** Их 230 штук
примерно на десять тысяч слов, и написаны они как объяснение читателю,
...
правилом CSS по `data-lang` на корне, а не двумястами тридцатью
правками по компонентам.
